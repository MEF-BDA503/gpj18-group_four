...
melted_data <- melted_data %>% filter((!is.na(Bins) & Bins!="1-10" &  Bins!="11-20" ) ) %>%  
...
ggplot(melted_data, aes(Bins)) + 
  ...
  labs(title="Number of Products according to ImportUnitPrice/ExportUnitPrice higher than 20 times",
...
* France, Germany, UK and US are the strongest countries in terms of buying products from Turkey, adding value to these products and selling back to Turkey.
