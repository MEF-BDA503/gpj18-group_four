...
set.seed(11)
fviz_nbclust(product_Cluster2, kmeans, method = "wss")


#Determine Optimal Cluster with Silhoutte Method
fviz_nbclust(product_Cluster2, kmeans, method = "silhouette")
...
k2 <- kmeans(product_Cluster2, centers = 4, nstart = 25)
print (k2)
fviz_cluster(k2, data = product_Cluster2)
