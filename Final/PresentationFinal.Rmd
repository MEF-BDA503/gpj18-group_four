...
## Explanation of Raw Data and Data Preparation

- 10 countries’ trade data against Turkey are taken from [Trademap.org](https://trademap.org/Index.aspx) as 4 seperate excel tables, Export&Import Quantity and Export&Import Values

- Quantity and Value tables joined following the binding operation of 10 countries tables. Besides, 2 digit product code table have been joined.

- Same type of variables collated to one and "years"" melted to prevent repetition of quantity and value variables. 
...
```{r, fig.align='center', fig.height=5, fig.width=4.5, include=FALSE}
...
## Analysis | Breakdown of Total Export & Import
...
## Analysis | Year over Year Changes in Trade Values - Export & Import - Canada {#slide36}
...
## Analysis | Year over Year Changes in Trade Values - Exports & Imports to Russia {#slide37}
...
## Analysis | Trade Deficit and Effects of Countries on Trade Deficit
...
<font size="3">As a result of descriptive analysis of Turkey's trade with G7 countries besides India, China and Russia, we noted that;</font>

* <font size="3">Turkeys’ biggest trade partners are China, Germany, Russia and US at import side while they are Germany, UK, Italy and USA at export side.</font> 
* <font size="3">Germany and USA are the 2 top countries seen in both directions of trade.</font>
* <font size="3">Generally we have fluctuated trade trend with Russia.</font>
* <font size="3">Turkey's trade deficit analyisis gives the results :</font> 
  + <font size="2">UK gives trade surplus for all years analysed</font> 
  + <font size="2">China, Russia, Germany and USA have the most significant effect on trade deficit</font>
  + <font size="2">Trade deficit has negatively correlated with USD/TL rate between 2013 and 2016 but there is no relation BIST100 index.</font>
  + <font size="2">Turkey's trade deficit comes from China, Russia, Germany countires and most of deficit comes from products below :</font>
      + <font size="2">Electrical machinery, equipments and machinery, mechanical appliances</font>
      + <font size="2">Mineral fuels, mineral oils and products of their distillation constitute</font> 
      + <font size="2">Vehicles other than railway and mechanical and electronical machinery and equipments</font>
* <font size="3">As a result of clustering exported products;</font>
  + <font size="2">Vehicles other than railway is the group we spent the most money</font>
  + <font size="2">Second group consist of Machinery, mechanical appliances, electronical machinery- equipments and clothing while third one includes iron, steel, pearls, ores etc.</font>
