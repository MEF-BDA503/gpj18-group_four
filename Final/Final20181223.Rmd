...
output:
  ...
  pdf_document:
    toc: yes
date: "December 2018"
subtitle: MEF University - BDA 503 Essentials of Data Analytics - Fall 2018 - Group
  Fou\*R* Term Project
---
...
#multiplot(plotCanEx, plotCanIm, plotRusEx, plotRusIm, cols=2)
...
![Import from China](C:\Users\emrek\Google Drive\BDA\503-EssentialsOfDataAnalytics\GitHub\gpj18-group_four\images\ChinaImport.png)
...
![Import from Russia](C:\Users\emrek\Google Drive\BDA\503-EssentialsOfDataAnalytics\GitHub\gpj18-group_four\images\RussiaImport.png)
...
![Import from Germany](C:\Users\emrek\Google Drive\BDA\503-EssentialsOfDataAnalytics\GitHub\gpj18-group_four\images\GermanyImport.png)
...
In order to examine the details, we builded ***[Shiny](https://groupfour.shinyapps.io/tradeOrgProUnitP/)*** app.
...
In order to see the segmentation of exported products by Turkey considering their share in total export value, we implemented k-means clustering method after scaling the export values of each product.  
...
* Vehicles other than railway can be classified as a group - the export products we spent too much money  

* Machinery, mechanical appliances, electronical machinery and equipments, clothing is another classification - top2 products in terms of money spent

* Third class consist of iron, steel, pearls, ores etc. and this class slightly differs from 4th group in terms of money spent
...
[TradeMap](https://trademap.org/Index.aspx)

[TCMB](http://tcmb.gov.tr)
...
[R-statistics blog](https://www.r-statistics.com/tag/transpose/)

[UC Business Analytics R Programming Guide](https://uc-r.github.io/kmeans_clustering#silo)
