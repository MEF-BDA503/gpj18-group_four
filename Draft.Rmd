...
In order to deeply understand the data; we build up shiny app with Country, Product and Year variables. 
...
altsinir=quantile(summarytableCanadaEx$ExpChngYoy, probs = c(0.25)) - (1.5*IQR)
ustsinir=quantile(summarytableCanadaEx$ExpChngYoy, probs = c(0.75)) + (1.5*IQR)
...
altsinir=quantile(summarytableCanadaIm$ImpChngYoy, probs = c(0.25)) - (1.5*IQR)
ustsinir=quantile(summarytableCanadaIm$ImpChngYoy, probs = c(0.75)) + (1.5*IQR)
...
altsinir=quantile(summarytableRussianEx$ExpChngYoy, probs = c(0.25)) - (1.5*IQR)
ustsinir=quantile(summarytableRussianEx$ExpChngYoy, probs = c(0.75)) + (1.5*IQR)
...
altsinir=quantile(summarytableRussianIm$ImpChngYoy, probs = c(0.25)) - (1.5*IQR)
ustsinir=quantile(summarytableRussianIm$ImpChngYoy, probs = c(0.75)) + (1.5*IQR)
